#define SSID "nagpalavnish11"     // "SSID-WiFiname"
#define PASS "avnish11nagpal" // "password"
...
String apiKey = "9AA5NA99PDEH9EPR";
String msg = "GET /update?key=9AA5NA99PDEH9EPR"; 
...
//String cmd="AT+CWJAP=\"nagpalavnish11\",\"avnish11nagpal\"";// SSID and Passwword
 String cmd="AT+CWJAP=\"";
  cmd+=SSID;
  cmd+="\",\"";
  cmd+=PASS;
